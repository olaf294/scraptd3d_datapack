...
execute as @a[team=Red] run scoreboard players operation @s trophies += $trophies trophies_add
...
{"text":"🏆"}]
execute as @a[team=Red] at @s run playsound entity.player.levelup record @s ~ ~ ~ 1
...
{"text":"Winner: "},{"text":"Red","color":"#ff2a2a","italic":false}]
