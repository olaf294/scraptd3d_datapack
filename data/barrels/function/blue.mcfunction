$execute if score $scrap scrap_b matches $(cost).. unless score Cooldown2 cooldown > #cooldown0 cooldown run summon marker 71 63 -1 {Tags:["$(tag)","barrel"]}
...
$execute if score $scrap scrap_b_billion matches 1.. unless score $scrap scrap_b matches $(cost).. unless score Cooldown2 cooldown > #cooldown0 cooldown run summon marker 71 63 -1 {Tags:["$(tag)","barrel"]}
